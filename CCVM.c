...
void (*ccvm_instructionset[256])(CCVM*) = {
  ...
  /* 0x70 */ ccvm_instructions_nop,
  /* 0x71 */ ccvm_instructions_nop,
  /* 0x72 */ ccvm_instructions_nop,
  /* 0x73 */ ccvm_instructions_nop,
  /* 0x74 */ ccvm_instructions_nop,
  /* 0x75 */ ccvm_instructions_nop,
  /* 0x76 */ ccvm_instructions_nop,
  /* 0x77 */ ccvm_instructions_nop,
  /* 0x78 */ ccvm_instructions_nop,
  /* 0x79 */ ccvm_instructions_nop,
  /* 0x7a */ ccvm_instructions_nop,
  /* 0x7b */ ccvm_instructions_nop,
  /* 0x7c */ ccvm_instructions_nop,
  /* 0x7d */ ccvm_instructions_nop,

...
void (*ccvm_instructionset[256])(CCVM*) = {
  ...
  /* 0x80 */ ccvm_instructions_math_pow_reg,
  /* 0x81 */ ccvm_instructions_math_pow_stack,
  /* 0x82 */ ccvm_instructions_math_pow_reg_num,
  /* 0x83 */ ccvm_instructions_math_pow_stack_num,
  /* 0x84 */ ccvm_instructions_math_sqrt_reg,
  /* 0x85 */ ccvm_instructions_math_sqrt_stack,
